...
User.create!([
  ...
  {username: "arvid", email: "lela_johnson@steuber.info", avatar_url: "https://robohash.org/etplaceatunde.png?size=300x300&set=set1", password_digest: "$2a$10$NtzZ3B0Q2/nPfM6T8AZ19ebQeN0SBrRn.kk6gtp.kZp/lQzBigqvy", session_token: "1ieyzVDX8c0VO5v-IpP8JA"},
  {username: "isac", email: "ardith_erdman@boehm.co", avatar_url: "https://robohash.org/molestiaererumvelit.png?size=300x300&set=set1", password_digest: "$2a$10$tbjLKNpVjBnhHvHY3gmoS.itg.BstiHriR/zzBs0FmWgTxnJGGX9m", session_token: "QTVXPzZ_RNa5MXrJj7dpxw"},
  {username: "haie.sporer", email: "oswaldo_boyle@kerluke.co", avatar_url: "https://robohash.org/recusandaeeaet.png?size=300x300&set=set1", password_digest: "$2a$10$nx3aNWwbpikcnrgbt6uM1.GUpJ1c9Gs.anP.7E/VtWtY/Xz72hYO.", session_token: "jy0DICL8zHGwUFhtccbJIQ"},
  {username: "angel.kilback", email: "augustine.donnelly@bashirian.net", avatar_url: "https://robohash.org/corruptiomniset.png?size=300x300&set=set1", password_digest: "$2a$10$sX7DSNXMUd8Xn/FTyng30uMBxx.JIJWoXRypR6qve26zlz9XSapSO", session_token: "b9DZ7zxHY4Zg8S_1DpR3BQ"},
  {username: "mac.ritchie", email: "treva@hammes.info", avatar_url: "https://robohash.org/autoccaecatibeatae.png?size=300x300&set=set1", password_digest: "$2a$10$6k8XeK.IFg/OXdjYnrXNv./Nk5MPghPpRoRbupGU6hL9XwN2L2jQq", session_token: "BhATkXt-MRbwq33UZFZSMg"},
  {username: "orin", email: "veronica.casper@schuppe.name", avatar_url: "https://robohash.org/sedetnam.png?size=300x300&set=set1", password_digest: "$2a$10$qBVMady8MWfauMT8taDfIOYNszrrmahqvkvfh//1Fd6YXIzzmv2fe", session_token: "Il5rQCIvbsUinwIf53yc1Q"},

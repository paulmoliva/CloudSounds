  ...
  container[audiojs] = {
    ...
    settings: {
      ...
      updatePlayhead: function(percent) {
        ...
        var width =((parseInt(progress.style.width.split('%')[0])) * 0.01) * (screen.width * 0.40)
        var trackID = $('.playing').attr('id').split('-')[1];
        var can = $(`canvas#waveform-progress-${trackID}`)[0]
        var interval = screen.width * 0.4 * 0.01;
        if (can) {
          console.log(width);
          var ctx = can.getContext('2d');
          ctx.clearRect(0,0,screen.width, 75);
          // ctx.fillStyle='rgba(255,255,255, 0.08)'
          // ctx.fillRect(width, 0, interval, 75);
          ctx.fillStyle='rgba(17,17,255, 0.45)';

...
(function(audiojs, audiojsInstance, container) {
  ...
  container[audiojs] = {
    ...
    settings: {
      ...
      loop: false,
      preload: true,
      imageLocation: 'https://res.cloudinary.com/cloud-sounds/image/upload/c_scale,w_1/v1473033713/loading5_kluvdv.gif',
      ...
      createPlayer: {
        markup: '\
          ...
          <div class="play-pause"> \
            ...
            <p class="pause"></p> \
            <p class="loading"> \
              <img style="margin-top:4px;"src="https://res.cloudinary.com/cloud-sounds/image/upload/c_scale,w_30/v1473033713/loading5_kluvdv.gif"> \
            </p> \
            <p class="error"></p> \
          </div> \
          <p class="skip"></p> \
          ...
          <div class= "nowplaying-badge"> \
          </div> \
          <div id="playlist-queue">Playlist▼ \
          </div> \
      ...
      css: '\
        ...
        .audiojs { width: 460px; height: 36px; background: #404040; font-family: monospace; font-size: 12px; \
      //     background-image: -webkit-gradient(linear, left top, left bottom, color-stop(0, #444), color-stop(0.5, #555), color-stop(0.51, #444), color-stop(1, #444)); \
      //     background-image: -moz-linear-gradient(center top, #444 0%, #555 50%, #444 51%, #444 100%); \
      //     -webkit-box-shadow: 1px 1px 8px rgba(0, 0, 0, 0.3); -moz-box-shadow: 1px 1px 8px rgba(0, 0, 0, 0.3); \
      //     -o-box-shadow: 1px 1px 8px rgba(0, 0, 0, 0.3); box-shadow: 1px 1px 8px rgba(0, 0, 0, 0.3); } \
        .audiojs .play-pause { width: 25px; height: 40px; padding: 0px 6px; padding-bottom:5px; margin: 0px; float: left; overflow: hidden; } \

  ...
  container[audiojs] = {
    ...
    settings: {
      ...
      updatePlayhead: function(percent) {
        ...
        console.log(parseInt(progress.style.width.split('%')[0]));
        let width =((parseInt(progress.style.width.split('%')[0])) * 0.01) * (screen.width * 0.40)
        let trackID = $('.playing').attr('id').split('-')[1];
        let can = $(`div#waveform-${trackID} wave canvas`)[0]
        console.log(can);
        console.log(width);
        if (can) {
          ...
          my_gradient.addColorStop(0, 'rgba(0, 0, 0, 0.01)');
          my_gradient.addColorStop(1, 'rgba(255,255,255, 0.01)');
